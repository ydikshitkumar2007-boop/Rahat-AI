...
export function Navbar() {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-white dark:bg-[#151A22] border-b border-[#E5DED3] dark:border-[#303949] shadow-xs backdrop-blur-md transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-bold bg-risk-severe/15 text-risk-severe border border-risk-severe/30 hover:bg-risk-severe hover:text-white transition-all shadow-xs"
            >
